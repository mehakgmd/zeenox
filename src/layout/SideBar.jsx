  ...
  return (
    <div className="hidden md:flex flex-col w-64 bg-gray-800 rounded-r-2xl">
      <div className="flex flex-col flex-1 overflow-y-auto">
        <nav className="flex flex-col flex-1 overflow-y-auto bg-gradient-to-b from-gray-700 to-blue-500 px-2 py-4 gap-10 rounded-r-2xl">
          <div>
            <a href="#" className="flex items-center gap-3 px-4 py-2 text-gray-100 hover:bg-gray-700">
